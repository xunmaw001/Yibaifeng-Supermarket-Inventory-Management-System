		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div v-if="detail.yuangongzhaopian" class="layui-input-block">
							<img id="yuangongzhaopianImg" style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;" :src="detail.yuangongzhaopian">
							<input type="hidden" :value="detail.yuangongzhaopian" id="yuangongzhaopian" name="yuangongzhaopian" />
						</div>
						<div class="layui-input-block">
							<button type="button" class="layui-btn btn-theme" id="yuangongzhaopianUpload">
								<i class="layui-icon">&#xe67c;</i>上传员工照片
							</button>
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						carousel.render({
							...
							indicator: "none"
                																																...
                																																vue.xingbie = '男,女'.split(',')
																																								// 上传图片
				var yuangongzhaopianUpload = upload.render({
					//绑定元素
					elem: '#yuangongzhaopianUpload',
					//上传接口
					...
					// 上传成功
						...
						if (res.code == 0) {
							...
							jquery('#yuangongzhaopian').val(url);
							jquery('#yuangongzhaopianImg').attr('src', url)
                            vue.detail.yuangongzhaopian = url;
						} else {
							layer.msg(res.msg, {
								time: 2000,
								icon: 5
