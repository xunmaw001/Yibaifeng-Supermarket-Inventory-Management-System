		...
		<div id="app">
			...
			<div class="data-container layui-row">
				...
				<div class="data-list layui-col-md8 layui-col-md-offset2">
					<div @click="jump('../shangpinxinxi/detail.jsp?id='+item.id)" v-for="(item,index) in dataList" v-bind:key="index"
					 class="data-item layui-col-md3">
						
						                                                                                                                                                                                                                                                <img :src="item.shangpintupian?item.shangpintupian.split(',')[0]:''" class="cover">
