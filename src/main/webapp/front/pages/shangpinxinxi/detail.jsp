				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>库存数量：</span>
							<span class="desc">
								{{detail.kucunshuliang}}
							</span>
						</div>
																																										<div class="detail-item">
							<span>商品说明：</span>
							<span class="desc">
								{{detail.shangpinshuoming}}
							</span>
						</div>
						...
						<div class="detail-item">
							...
							<button @click="addCartTap" type="button" class="layui-btn layui-btn-warm">
								...
								立即购买
														...
														<button @click="jifenTap" type="button" class="layui-btn btn-warning">
								积分兑换
							</button>
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('shangpinxinxi','维护')" @click="onAcrossTap('shangpinweihu')" type="button" class="layui-btn">
								维护
							</button>
																					<button v-if="isAuth('shangpinxinxi','入库')" @click="onAcrossTap('rukujilu')" type="button" class="layui-btn">
								入库
							</button>
																					<button v-if="isAuth('shangpinxinxi','出库')" @click="onAcrossTap('chukujilu')" type="button" class="layui-btn">
								出库
							</button>
				...
				methods: {
					...
					jifenTap() {
						...
						localStorage.setItem('orderGoods', JSON.stringify([{
							...
							discountprice: this.detail.jifen ? this.detail.jifen : 0
						}]));
						// 跳转到确认下单页面,并且携带参数type=2代表是积分兑换
						jump('../order/confirm.jsp?type=2');
					},
