...
<body>
								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
										...
										<input id="lianxidianhua" name="lianxidianhua" class="form-control" placeholder="联系电话">
											...
											<div class="form-group col-md-6">
										<label>电子邮箱</label>
										<input id="dianziyouxiang" name="dianziyouxiang" class="form-control" placeholder="电子邮箱">
									</div>
											<div class="form-group col-md-6">
										<label>身份证号</label>
										<input id="shenfenzhenghao" name="shenfenzhenghao" class="form-control" placeholder="身份证号">
											...
											<div class="form-group col-md-6">
																				<label>员工照片</label>
																				<img id="yuangongzhaopianImg" src="" width="100" height="100">
										<input name="file" type="file" id="yuangongzhaopianupload" class="form-control-file">
										<input name="yuangongzhaopian" id="yuangongzhaopian-input" type="hidden">
									</div>
											<div class="form-group col-md-6">
										<label>积分</label>
	...
	<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/resources/js/datetimepicker/bootstrap-datetimepicker.min.js"></script>
		...
		// 文件上传
		function upload(){
																																																													$('#yuangongzhaopianupload').fileupload({
						url: baseUrl + 'file/upload',
						headers:{ token: window.sessionStorage.getItem("token")},
						dataType: 'json',
						done: function (e, data) {				
							document.getElementById('yuangongzhaopian-input').setAttribute('value',baseUrl+"upload/"+data.result.file);
							if(document.getElementById('yuangongzhaopianFileName') != null){
								document.getElementById('yuangongzhaopianFileName').innerHTML = "上传成功!";
							}				
							$("#yuangongzhaopianImg").attr("src",baseUrl+"upload/"+data.result.file);								
						}
					});
																							}  
					...
					for(var xingbieCount = 0; xingbieCount < xingbieOptions.length;xingbieCount++){
						if(xingbieOptions[xingbieCount].getAttribute('value') == ruleForm.xingbie){
							xingbieOptions[xingbieCount].setAttribute('selected','selected');
																...
																$("#yuangongzhaopian-input").val(ruleForm.yuangongzhaopian);
																$("#jifen").val(ruleForm.jifen);	
																$("#money").val(ruleForm.money);	
									}		
		//图片显示
		function showImg(){
																																																													var yuangongzhaopianFileName = "\"" + ruleForm.yuangongzhaopian + "\"";
					$("#yuangongzhaopianImg").attr("src",ruleForm.yuangongzhaopian);
																							}		
		//跨表
								...
								for(var xingbieCount = 0; xingbieCount < xingbieOptions.length;xingbieCount++){
									if(xingbieOptions[xingbieCount].getAttribute('value') == res.data.xingbie){
										xingbieOptions[xingbieCount].setAttribute('selected','selected');
												...
												if(res.data != null && res.data != '' && res.data.yuangongzhaopian != null && res.data.yuangongzhaopian != ''){

															$("#yuangongzhaopianImg").attr("src",res.data.yuangongzhaopian);
								$("#yuangongzhaopian-input").val(res.data.yuangongzhaopian);
													}
												if(res.data != null && res.data != '' && res.data.jifen != null && res.data.jifen != ''){

															$("#jifen").val(res.data.jifen);
													}
