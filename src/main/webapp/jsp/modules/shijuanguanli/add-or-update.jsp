				...
				<div class="row breadcrumb-bar">
					...
					<div class="col-md-6">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">编辑试卷</li>
						</ol>
					</div>
				</div>
			</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">试卷信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>试卷名称</label> <input id="name" name="name"
											class="form-control" placeholder="试卷名称">
									</div>

									<div class="form-group col-md-6">
										<label>考试时长</label> <input id="time"
											name="time" class="form-control" placeholder="考试时长(分钟)">
									</div>

									<div class="form-group col-md-6">
										<label>试卷状态</label> 
										<select id="statusSelect" name="status">
											<option value="1" class="statusOption">启用</option>
											<option value="0" class="statusOption">禁用</option>
										</select>
									</div>
