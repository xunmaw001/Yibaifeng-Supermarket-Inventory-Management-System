...
<body>
				...
				<div class="row breadcrumb-bar">
					...
					<div class="col-md-6">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item">试卷管理</li>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">试卷管理列表</h3>
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
									<label> 试卷名称 <input type="text" id="nameSearch"
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('time')">考试时长<i
												id="timeIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('status')">试卷状态<i
												id="statusIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('addtime')">创建时间<i
	...
	<%@ include file="../../static/crossBtnControl.js"%>
		...
		function setDataRow(item, number) {
			...
			if(item.status == 1){
				statusCell.innerHTML = "<span class=\"badge badge-success\">启用</span>";
			}else{
				statusCell.innerHTML = "<span class=\"badge badge-secondary\">禁用</span>";
			}
