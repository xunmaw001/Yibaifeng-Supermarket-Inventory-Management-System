		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑商品维护</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">编辑商品维护</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">商品维护信息</h3>
								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
										...
										<input id="shangpinmingcheng" name="shangpinmingcheng" class="form-control" placeholder="商品名称">
											...
											<div class="form-group col-md-6">
										<label>商品类型</label>
										<input id="shangpinleixing" name="shangpinleixing" class="form-control" placeholder="商品类型">
									</div>
											<div class="form-group col-md-6">
										<label>维护状态</label>
										<select id="weihuzhuangtaiSelect" name="weihuzhuangtai" class="form-control">
																						<option value=" "></option>
																																					<option class="weihuzhuangtaiOption" value="商品损坏">
														商品损坏
													</option>
																										<option class="weihuzhuangtaiOption" value="维护中">
														维护中
													</option>
																										<option class="weihuzhuangtaiOption" value="补货中">
														补货中
													</option>
																										<option class="weihuzhuangtaiOption" value="维护完成">
														维护完成
													</option>
																																			</select>	
									</div>	
										...
										<div id="dengjishijianDate" class="input-append date form_datetime">
											...
											<div class="form-group col-md-6">
										<label>维护说明</label>
										<textarea name="weihushuoming" class="form-control" id="weihushuoming" rows="3"></textarea>
									</div>
	...
	<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/resources/js/datetimepicker/bootstrap-datetimepicker.min.js"></script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "shangpinweihu/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("shangpinweihu/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("shangpinweihu/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			$("#updateId").val(ruleForm.id);	
												$("#gonghao").val(ruleForm.gonghao);	
																...
																var weihuzhuangtaiOptions = document.getElementsByClassName("weihuzhuangtaiOption");
					for(var weihuzhuangtaiCount = 0; weihuzhuangtaiCount < weihuzhuangtaiOptions.length;weihuzhuangtaiCount++){
						if(weihuzhuangtaiOptions[weihuzhuangtaiCount].getAttribute('value') == ruleForm.weihuzhuangtai){
							weihuzhuangtaiOptions[weihuzhuangtaiCount].setAttribute('selected','selected');
						}
					}
																$("#dengjishijian-input").val(ruleForm.dengjishijian);
																$("#weihushuoming-input").val(ruleForm.weihushuoming);
									}		
		//图片显示
		function showImg(){
																																																													}		
				...
				http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
												...
												if(res.data != null && res.data != '' && res.data.weihuzhuangtai != null && res.data.weihuzhuangtai != ''){

															var weihuzhuangtaiOptions = document.getElementsByClassName("weihuzhuangtaiOption");
								for(var weihuzhuangtaiCount = 0; weihuzhuangtaiCount < weihuzhuangtaiOptions.length;weihuzhuangtaiCount++){
									if(weihuzhuangtaiOptions[weihuzhuangtaiCount].getAttribute('value') == res.data.weihuzhuangtai){
										weihuzhuangtaiOptions[weihuzhuangtaiCount].setAttribute('selected','selected');
									}
								}
													}
								...
								$('#dengjishijianFileName').val(res.data.dengjishijian)
												...
												if(res.data != null && res.data != '' && res.data.weihushuoming != null && res.data.weihushuoming != ''){

															$("#weihushuoming-input").val(res.data.weihushuoming);
													}
											}
				});  
            }
