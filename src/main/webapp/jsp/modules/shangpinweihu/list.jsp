		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">商品维护管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">商品维护管理</li>
								<li class="breadcrumb-item active">商品维护列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">商品维护列表</h3>							
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
												...
												<input type="text" id="shangpinmingchengSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
																																																														...
																																																														<label>
												商品类型
												<input type="text" id="shangpinleixingSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
											</label>
																																																														<label>
												维护状态
												<select name="weihuzhuangtai" id="weihuzhuangtaiSelect" class="form-control form-control-sm" aria-controls="tableId">
																											<option value=" "> </option>
												...
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																																						...
																																						<th onclick="sort('gonghao')">工号<i id="gonghaoIcon" class="fa fa-sort"></i></th>
																																																			...
																																																			<th onclick="sort('weihuzhuangtai')">维护状态<i id="weihuzhuangtaiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
					...
					searchForm.shangpinmingcheng ="%" +  $('#shangpinmingchengSearch').val() + "%";
																				...
																				if($('#shangpinleixingSearch').val() != null && $('#shangpinleixingSearch').val() != ''){
					searchForm.shangpinleixing ="%" +  $('#shangpinleixingSearch').val() + "%";
				}
				
																				var weihuzhuangtaiIndex = document.getElementById("weihuzhuangtaiSelect").selectedIndex;
				var weihuzhuangtaiOptions = document.getElementById("weihuzhuangtaiSelect").options;
				var weihuzhuangtaiSelectedOption = weihuzhuangtaiOptions[weihuzhuangtaiIndex]
				if(weihuzhuangtaiSelectedOption.text != null && weihuzhuangtaiSelectedOption.text != ''){
					searchForm.weihuzhuangtai = "%" + weihuzhuangtaiSelectedOption.text + "%";
				}
																						getDataList();
		}		
		// 获取数据列表
        function getDataList() {
			http("shangpinweihu/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
																																	...
																																	weihuzhuangtai : searchForm.weihuzhuangtai,	
																																				},(res)=>{
				if(res.code == 0){
					clear();
			...
			row.appendChild(checkbox)
							...
							var gonghaoCell  = document.createElement('td');
									...
									row.appendChild(shangpinleixingCell);
				            				var weihuzhuangtaiCell  = document.createElement('td');

												  weihuzhuangtaiCell.innerHTML = item.weihuzhuangtai; 
                
									row.appendChild(weihuzhuangtaiCell);
									...
									row.appendChild(dengjishijianCell);
				            				var weihushuomingCell  = document.createElement('td');

												  if(item.weihushuoming != null && item.weihushuoming != "" && item.weihushuoming.length >= 11){
				  	weihushuomingCell.innerHTML = item.weihushuoming.substring(0, 10) + "..."; 
				  }else{
				  	weihushuomingCell.innerHTML = item.weihushuoming;
				  }

				
									row.appendChild(weihushuomingCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("shangpinweihu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function getSum(colName){
			http("shangpinweihu"+colName,"GET",{
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"shangpinweihu");
