...
<body>
								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
																					...
																					<div class="form-group col-md-6">
																								...
																								<input id="kucunshuliang" name="kucunshuliang" class="form-control" v-model="ruleForm.kucunshuliang" readonly>
																							</div>
																					...
																					<div class="form-group col-md-6">
																								...
																								<input id="jifen" name="jifen" class="form-control" v-model="ruleForm.jifen" readonly>
																							</div>
												...
												<label>商品说明</label>
												<script id="shangpinshuomingEditor" type="text/plain" style="width:800px;height:230px;"></script>
												<script type="text/javascript">
												    //建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例
												   //相见文档配置属于你自己的编译器
												 var shangpinshuomingUe = UE.getEditor('shangpinshuomingEditor', {
													toolbars: [
														[
															'undo', //撤销
															'bold', //加粗
												...
												<input type="hidden" name="shangpinshuoming" id="shangpinshuoming-input">
											</div>
																																																													<div class="form-group  col-md-12">
												<label>商品详情</label>
	...
	<script>
		...
		// 填充富文本框
		function setContent(){
																																								if(ruleForm.shangpinshuoming != null && ruleForm.shangpinshuoming != 'null' && ruleForm.shangpinshuoming != ''){
					var mes = '' + ruleForm.shangpinshuoming;
					var shangpinshuomingUeditor = UE.getEditor('shangpinshuomingEditor');
					shangpinshuomingUeditor.ready(function() {
						shangpinshuomingUeditor.setContent(mes);
						shangpinshuomingUeditor.setDisabled('fullscreen');
					});
				}
