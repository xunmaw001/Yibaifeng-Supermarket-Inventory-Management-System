								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
										...
										<select id="shangpinleixingSelect" name="shangpinleixing" class="form-control">
											...
											<div class="form-group col-md-6">
										<label>库存数量</label>
										<input id="kucunshuliang" name="kucunshuliang" class="form-control" placeholder="库存数量">
									</div>
											<div class="form-group col-md-6">
																				<label>商品图片</label>
																				<img id="shangpintupianImg" src="" width="100" height="100">
										<input name="file" type="file" id="shangpintupianupload" class="form-control-file">
										<input name="shangpintupian" id="shangpintupian-input" type="hidden">
									</div>
											<div class="form-group col-md-6">
										<label>商品说明</label>
										<textarea name="shangpinshuoming" class="form-control" id="shangpinshuoming" rows="3"></textarea>
									</div>
																	<div class="form-group col-md-6">
										<label>积分</label>
										<input id="jifen" name="jifen" type="number" class="form-control" placeholder="积分">
									</div>	
											<div class="form-group col-md-6">
										<label>价格</label>
					...
					for(var shangpinleixingCount = 0; shangpinleixingCount < shangpinleixingOptions.length;shangpinleixingCount++){
						if(shangpinleixingOptions[shangpinleixingCount].getAttribute('value') == ruleForm.shangpinleixing){
							shangpinleixingOptions[shangpinleixingCount].setAttribute('selected','selected');
																...
																$("#kucunshuliang").val(ruleForm.kucunshuliang);	
																$("#shangpintupian-input").val(ruleForm.shangpintupian);
																$("#shangpinshuoming-input").val(ruleForm.shangpinshuoming);
					...
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
								...
								for(var shangpinleixingCount = 0; shangpinleixingCount < shangpinleixingOptions.length;shangpinleixingCount++){
									if(shangpinleixingOptions[shangpinleixingCount].getAttribute('value') == res.data.shangpinleixing){
										shangpinleixingOptions[shangpinleixingCount].setAttribute('selected','selected');
												...
												if(res.data != null && res.data != '' && res.data.kucunshuliang != null && res.data.kucunshuliang != ''){

															$("#kucunshuliang").val(res.data.kucunshuliang);
													}
								...
								$("#shangpintupian-input").val(res.data.shangpintupian);
												...
												if(res.data != null && res.data != '' && res.data.shangpinshuoming != null && res.data.shangpinshuoming != ''){

															$("#shangpinshuoming-input").val(res.data.shangpinshuoming);
													}
