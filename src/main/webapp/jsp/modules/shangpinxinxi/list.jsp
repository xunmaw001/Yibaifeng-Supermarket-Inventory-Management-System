												...
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																																						...
																																						<th onclick="sort('shangpinbianhao')">商品编号<i id="shangpinbianhaoIcon" class="fa fa-sort"></i></th>
																																																			...
																																																			<th onclick="sort('kucunshuliang')">库存数量<i id="kucunshuliangIcon" class="fa fa-sort"></i></th>
																																																			
																													<th>商品图片</th>
																																																																	
																													<th>商品说明</th>
																																																																	<th onclick="sort('shangpinxiangqing')">商品详情<i id="shangpinxiangqingIcon" class="fa fa-sort"></i></th>
																																						
																																						
																																																			<th onclick="sort('jifen')">积分<i id="jifenIcon" class="fa fa-sort"></i></th>
	...
	<script>
			...
			row.appendChild(checkbox)
							...
							var shangpinbianhaoCell  = document.createElement('td');
									...
									row.appendChild(shangpinleixingCell);
				            				var kucunshuliangCell  = document.createElement('td');

												 kucunshuliangCell.innerHTML = item.kucunshuliang;

				
									row.appendChild(kucunshuliangCell);
				  ...
				  shangpintupianCell.appendChild(shangpintupianImg);
									...
									row.appendChild(shangpintupianCell);
				            				var shangpinshuomingCell  = document.createElement('td');

												  if(item.shangpinshuoming != null && item.shangpinshuoming != "" && item.shangpinshuoming.length >= 11){
				  	shangpinshuomingCell.innerHTML = item.shangpinshuoming.substring(0, 10) + "..."; 
				  }else{
				  	shangpinshuomingCell.innerHTML = item.shangpinshuoming;
				  }

				
									row.appendChild(shangpinshuomingCell);
				            				var shangpinxiangqingCell  = document.createElement('td');

												  //如果图文详情包含图片
				  if(item.shangpinxiangqing && item.shangpinxiangqing.indexOf('img') != -1){
					//暂时只考虑图片+文字 和 文字+图片的情况
					var beginIndex = item.shangpinxiangqing.indexOf('<img');
					var endIndex = item.shangpinxiangqing.indexOf('>');				
					shangpinxiangqingCell.innerHTML = item.shangpinxiangqing.substring(beginIndex, endIndex+1).replace("img","img width='100' height='100'");				
				  }else{
				  	 if(item.shangpinxiangqing != null && item.shangpinxiangqing != "" && item.shangpinxiangqing.length >= 11){
				  		shangpinxiangqingCell.innerHTML = item.shangpinxiangqing.substring(0, 10) + "..."; 
				  	}else{
				  		shangpinxiangqingCell.innerHTML = item.shangpinxiangqing;
				 	}
				  }
				  

                
									row.appendChild(shangpinxiangqingCell);
		...
		function detail(id){
			...
			window.location.href = "info.jsp";
					...
					//填充下拉框选项
					http("option/shangpinfenlei/shangpinleixing","GET",{},(res)=>{
						if(res.code == 0){
