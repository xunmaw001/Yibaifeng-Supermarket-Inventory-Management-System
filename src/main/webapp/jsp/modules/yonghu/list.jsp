			...
			row.appendChild(checkbox)
							...
							var yonghumingCell  = document.createElement('td');
									...
									row.appendChild(shenfenzhenghaoCell);
				            				var gerenzhaopianCell  = document.createElement('td');

								                  var gerenzhaopianImg = document.createElement('img');
				  gerenzhaopianImg.setAttribute('src',item.gerenzhaopian);
				  gerenzhaopianImg.setAttribute('height',100);
				  gerenzhaopianImg.setAttribute('width',100);
				  gerenzhaopianCell.appendChild(gerenzhaopianImg);

				
									row.appendChild(gerenzhaopianCell);
