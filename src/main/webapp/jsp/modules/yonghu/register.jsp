					...
					<div class="account-box">
						<form id="registerForm" action="" method="post">
										...
										<input type="text" name="xingming" placeholder="姓名" class="form-control">
																																																					...
																																																					<div class="form-group">
										<label>联系电话</label> 
										<input type="text" name="lianxidianhua" placeholder="联系电话" class="form-control">
										</div>
																																				<div class="form-group">
										<label>电子邮箱</label> 
										<input type="text" name="dianziyouxiang" placeholder="电子邮箱" class="form-control">
										</div>
																																				<div class="form-group">
										<label>身份证号</label> 
										<input type="text" name="shenfenzhenghao" placeholder="身份证号" class="form-control">
										</div>
