...
<body>
								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
										...
										<input id="shenfenzhenghao" name="shenfenzhenghao" class="form-control" placeholder="身份证号">
											...
											<div class="form-group col-md-6">
																				<label>个人照片</label>
																				<img id="gerenzhaopianImg" src="" width="100" height="100">
										<input name="file" type="file" id="gerenzhaopianupload" class="form-control-file">
										<input name="gerenzhaopian" id="gerenzhaopian-input" type="hidden">
									</div>
											<div class="form-group col-md-6">
										<label>积分</label>
	...
	<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/resources/js/datetimepicker/bootstrap-datetimepicker.min.js"></script>
		...
		// 文件上传
		function upload(){
																																																													$('#gerenzhaopianupload').fileupload({
						url: baseUrl + 'file/upload',
						headers:{ token: window.sessionStorage.getItem("token")},
						dataType: 'json',
						done: function (e, data) {				
							document.getElementById('gerenzhaopian-input').setAttribute('value',baseUrl+"upload/"+data.result.file);
							if(document.getElementById('gerenzhaopianFileName') != null){
								document.getElementById('gerenzhaopianFileName').innerHTML = "上传成功!";
							}				
							$("#gerenzhaopianImg").attr("src",baseUrl+"upload/"+data.result.file);								
						}
					});
																							}  
					...
					for(var xingbieCount = 0; xingbieCount < xingbieOptions.length;xingbieCount++){
						if(xingbieOptions[xingbieCount].getAttribute('value') == ruleForm.xingbie){
							xingbieOptions[xingbieCount].setAttribute('selected','selected');
																...
																$("#gerenzhaopian-input").val(ruleForm.gerenzhaopian);
																$("#jifen").val(ruleForm.jifen);	
																$("#money").val(ruleForm.money);	
									}		
		//图片显示
		function showImg(){
																																																													var gerenzhaopianFileName = "\"" + ruleForm.gerenzhaopian + "\"";
					$("#gerenzhaopianImg").attr("src",ruleForm.gerenzhaopian);
																							}		
		//跨表
								...
								for(var xingbieCount = 0; xingbieCount < xingbieOptions.length;xingbieCount++){
									if(xingbieOptions[xingbieCount].getAttribute('value') == res.data.xingbie){
										xingbieOptions[xingbieCount].setAttribute('selected','selected');
												...
												if(res.data != null && res.data != '' && res.data.gerenzhaopian != null && res.data.gerenzhaopian != ''){

															$("#gerenzhaopianImg").attr("src",res.data.gerenzhaopian);
								$("#gerenzhaopian-input").val(res.data.gerenzhaopian);
													}
