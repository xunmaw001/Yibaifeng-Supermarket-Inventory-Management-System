...
<body>
		...
		<div id="content">
			...
			<div class="container mt-0">
				<div class="row breadcrumb-bar">
					<div class="col-md-6">
						<h3 class="block-title">试卷列表管理</h3>
					</div>
					<div class="col-md-6">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item">试卷列表管理</li>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">试卷列表列表</h3>
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
									<label> 试卷 <input type="text" id="nameSearch"
	...
	<%@ include file="../../static/crossBtnControl.js"%>
		...
		function setDataRow(item, number) {
			...
			var editAttr = 'exam(' + item.id + ')';
			editBtn.setAttribute("type", "button");
			editBtn.setAttribute("class", "btn btn-warning btn-sm 考试");
			editBtn.setAttribute("onclick", editAttr);
			editBtn.innerHTML = "考试"
